...
Форма имеет вид как показано на рис.\ref{fig:FormInConstruct1}:
...
При запуске приложения на экране появляется окно как показано на рис.\ref{fig:StartForm1}.
...
При запуске с корректными данными как показано на рис.\ref{fig:WorkForm1}
...
При запуске с некорректными данными как показано на рис.\ref{fig:BadInputNotIntForm1}
