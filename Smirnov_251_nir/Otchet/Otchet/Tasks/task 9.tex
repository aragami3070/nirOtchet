...
Форма имеет вид как показано на рис.\ref{fig:FormInConstruct9}:
...
При запуске приложения на экране появляется окно с одним из случайно выбранных вопросов как показано на рис.\ref{fig:StartForm9}.
...
При запуске с корректными данными (правильным ответом в данном примере), при нажатии на кнопку <<Далее>> происходит как показано на рис.\ref{fig:WorkForm9}:
...
При запуске с некорректными данными, при нажатии на кнопку <<Далее>> происходит как показано на рис.\ref{fig:BadInputNotIntForm9}:
